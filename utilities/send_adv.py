...
async def button_sender(ctx, advname, page, msgid = 0):
    ...
    if choice_num==1:
        ...
        if msgid==0:
            msg = await ctx.send(embed=discord.Embed(title=advname,
            ...
            await ctx.edit(embed=discord.Embed(title=advname,
                                     description=content), components=[[
                            Button(label=label1,
                                    custom_id="option_1",
                                    style=ButtonStyle.grey)]])
    ...
    if choice_num==4:
        ...
        if msgid==0:
            ...
            msg = await ctx.edit(embed=discord.Embed(title=advname,
                                     description=content), components=[[
                            Button(label=label1,
                                    custom_id="option_1",
                                    style=ButtonStyle.grey),
